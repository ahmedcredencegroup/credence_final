...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Editorial interior design across residences, hotels, restaurants and boutiques — drawn, sourced and supervised in-house." },
      { name: "author", content: "Credence Groups" },
      { property: "og:title", content: "Credence Groups — Interior Design Studio" },
      { property: "og:description", content: "Editorial interior design across residences, hotels, restaurants and boutiques — drawn, sourced and supervised in-house." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Credence Groups — Interior Design Studio" },
      { name: "twitter:description", content: "Editorial interior design across residences, hotels, restaurants and boutiques — drawn, sourced and supervised in-house." },
